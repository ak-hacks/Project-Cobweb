...
$.each(articles, function(i,article){
  ...
  var source = itemExists(nodes, article),
    ...
    console.log(itemExists(nodes, article.belongs[0]), itemExists(nodes, article.belongs[1]), existing_item_link_index);
...
var force = d3.layout.force()
    .charge(-500)
    .linkDistance(function(d){ return (d.type==="article" ? 70 : 200); })
    .size([width, height]);
...
// Set circle
node.append("circle")
  .attr("r", function(d) { return (d.type==="article" ? 20 : 50); })
  .style("fill", function(d) { return (d.type==="article" ? "#FFF1E0" : (d.type==="person" ? "#9F9" : "#9CF")); });
